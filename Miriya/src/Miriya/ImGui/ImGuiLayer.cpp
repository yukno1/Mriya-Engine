...
namespace Miriya {
    ...
    void ImGuiLayer::OnUpdate() {
        ...
        io.DeltaTime = m_Time > 0.0f ? (time - m_Time) : (1.0f / 60.0f); // else deal as 60 fps
        m_Time = time;
    ...
    void ImGuiLayer::OnEvent(Event &event) {
        ...
        dispatcher.Dispatch<WindowResizeEvent>(MIR_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
    }
    ...
    bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent &e) {
        ImGuiIO &io = ImGui::GetIO();
        ImGuiKey key = Glfw_KeyToImGuiKey(e.GetKeyCode());
    ...
    bool ImGuiLayer::OnKeyReleasedEvent(KeyReleasedEvent &e) {
        ...
        // Only add the key event if we have a valid ImGuiKey
